...
public class Rectangle extends GeometricObject {
    //begin and end are opposite corners; no guranties wihch one.
    private Point begin;
    private Point end;

    public Rectangle() {
        begin = new Point(0,0); //begin-upper corner = (0,0)
        end = new Point(1,1); //end0-lower corner = (1,1)
    }
    ...
    /**
     * Caclulates the height of this rectangle.
    ...
    */
    ...
    /**
     * Determines if tgiven point is contained in this rectangle.
     * 
     * @param p given point.
     * @return true if p is on the poundary or the interior of this rectangle.
     */
